...
def create_agent(  # noqa: PLR0915
    *,
    ...
    graph.add_node("model_request", RunnableLambda(model_request, amodel_request))
    ...
    for m in middleware:
        if (
            ...
            before_node = RunnableLambda(sync_before, async_before)
            graph.add_node(
        ...
        if (
            ...
            after_node = RunnableLambda(sync_after, async_after)
            graph.add_node(
