...
from src.agents.agents._internal._runnable import RunnableLike
...
from src.agents.agents.middleware_agent import create_agent as create_middleware_agent
from src.agents.agents.structured_output import (
...
from src.agents.agents.chat_models import init_chat_model
...
if TYPE_CHECKING:
    ...
    from src.agents.agents._internal._typing import (
        SyncOrAsync,
    )
...
class _AgentBuilder(Generic[StateT, ContextT, StructuredResponseT]):
    ...
    def create_model_node(self) -> RunnableLambda:
        ...
        return RunnableLambda(call_model, acall_model)
